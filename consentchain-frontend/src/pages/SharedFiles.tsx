...
function TextPreview({ url }: { url: string }) {
  ...
  return (
    <pre className="w-full h-full max-h-[60vh] overflow-auto font-mono text-xs text-white/60 bg-black/30 rounded-xl p-4 whitespace-pre-wrap">
      {content || "Loading..."}
    </pre>
  );
}
      ...
      <div className="flex-1 overflow-y-auto px-10 py-10 space-y-8">
        ...
        >
          <div className="flex items-end justify-between">
            <div>
              <p className="text-[10px] font-mono text-purple-400 tracking-[0.3em] uppercase mb-1">
                Inbox
              </p>
              ...
              <p className="text-white/20 text-sm font-mono mt-1">
                Files others have granted you access to
              </p>
            </div>
                ...
                return (
                  <div
                    ...
                    className={`group flex items-center gap-5 bg-[#0e0e0e] border rounded-2xl px-6 py-4 transition-all duration-300
                      ${
                        isHovered
                          ? "border-purple-500/25 bg-purple-500/5 shadow-lg shadow-purple-500/5"
                          : "border-white/5"
                      }
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0 w-48">
                      <div
                        className={`w-7 h-7 rounded-full border flex items-center justify-center text-[11px] font-mono font-bold shrink-0 ${ownerColor}`}
                      >
                    ...
                    <span
                      className={`text-white/10 text-sm shrink-0 transition-all duration-300 ${
                        isHovered ? "opacity-100 text-white/30" : "opacity-0"
                      }`}
                    >
                      →
                    </span>
